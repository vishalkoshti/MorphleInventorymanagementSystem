...
{
    public partial class searchBOM : System.Web.UI.Page
    {
        ...
        protected void search_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                SqlCommand cmd = new SqlCommand("select * from BOM where Part_Number like'%" + TextBox1.Text + "%'", con);
            ...
            {
                con.Open();
                SqlCommand cmd = new SqlCommand("select * from BOM where Part_Discription like'%" + TextBox1.Text + "%'", con);
                SqlDataAdapter da = new SqlDataAdapter(cmd);
                DataSet ds = new DataSet();
                da.Fill(ds);
                con.Close();
        ...
        private void ExportGridToExcel()
        {
            ...
            Response.Charset = "";
            string FileName = "BOM" + DateTime.Now + ".xls";
